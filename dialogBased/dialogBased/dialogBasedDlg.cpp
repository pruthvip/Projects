...
// dialogBasedDlg.cpp : implementation file
//
...
CdialogBasedDlg::CdialogBasedDlg(CWnd* pParent /*=NULL*/)
	: CDialog(CdialogBasedDlg::IDD, pParent)
{
	m_hIcon = AfxGetApp()->LoadIcon(IDR_MAINFRAME);
}

void CdialogBasedDlg::DoDataExchange(CDataExchange* pDX)
{
